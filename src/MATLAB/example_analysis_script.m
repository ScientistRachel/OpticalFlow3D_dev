...
tRange = 4:28; % which frames should be analyzed? Indexing begins at 1.
...
relPer = 40; % Percentile threshold for reliability
...
% preallocates the storage for that.
...
set(gca,'FontSize',16)
ylim([0 max(meanMag)+0.1]) % Magnitude is bounded by zero
box off
